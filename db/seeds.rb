...
Vote.create(voteable_id: '1', voteable_type: 'Answer', user_id: '1')
Vote.create(voteable_id: '1', voteable_type: 'Answer', user_id: '2')
Vote.create(voteable_id: '1', voteable_type: 'Answer', user_id: '3')
Vote.create(voteable_id: '1', voteable_type: 'Question', user_id: '1')
Vote.create(voteable_id: '1', voteable_type: 'Question', user_id: '2')
Vote.create(voteable_id: '1', voteable_type: 'Question', user_id: '3')

Vote.create(voteable_id: '2', voteable_type: 'Answer', user_id: '1')
Vote.create(voteable_id: '2', voteable_type: 'Answer', user_id: '2')
Vote.create(voteable_id: '2', voteable_type: 'Answer', user_id: '3')
Vote.create(voteable_id: '2', voteable_type: 'Question', user_id: '1')
Vote.create(voteable_id: '2', voteable_type: 'Question', user_id: '2')
Vote.create(voteable_id: '2', voteable_type: 'Question', user_id: '3')

Vote.create(voteable_id: '3', voteable_type: 'Answer', user_id: '1')
Vote.create(voteable_id: '3', voteable_type: 'Answer', user_id: '2')
Vote.create(voteable_id: '3', voteable_type: 'Answer', user_id: '3')
Vote.create(voteable_id: '3', voteable_type: 'Question', user_id: '1')
Vote.create(voteable_id: '3', voteable_type: 'Question', user_id: '2')
Vote.create(voteable_id: '3', voteable_type: 'Question', user_id: '3')
